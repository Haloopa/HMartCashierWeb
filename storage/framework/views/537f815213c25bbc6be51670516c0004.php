<div class="font-mono text-sm">
    ...
    <div class="mb-3">
        <p>Invoice: <?php echo e($transaction->invoice_number); ?></p>
        <p>Tanggal: <?php echo e($transaction->created_at->format('d/m/Y H:i:s')); ?></p>
    ...
    <div class="mb-4">
        <div class="flex justify-between">
            <span>Total:</span>
            <span class="font-bold">Rp <?php echo e(number_format($transaction->total_amount, 0, ',', '.')); ?></span>
        </div>
        <div class="flex justify-between">
            <span>Bayar:</span>
            <span>Rp <?php echo e(number_format($transaction->payment_amount, 0, ',', '.')); ?></span>
        </div>
        <div class="flex justify-between">
            <span>Kembali:</span>
...
</div><?php /**PATH D:\KULIAH\SERTIFIKASI\h-mart-kasir\resources\views/cashier/receipt.blade.php ENDPATH**/ ?>