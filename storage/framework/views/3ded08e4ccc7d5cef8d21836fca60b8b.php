...
<head>
    ...
    <title>H'Mart Cashier - <?php echo $__env->yieldContent('title'); ?></title>
...
<body class="bg-gray-50">
    <div class="flex h-screen">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" 
                       class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg 
                              <?php echo e(request()->routeIs('dashboard') ? 'active text-white' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('cashier.index')); ?>" 
                       class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg
                              <?php echo e(request()->routeIs('cashier.*') && !request()->routeIs('cashier.transactions') ? 'active text-white' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('cashier.transactions')); ?>" 
                       class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg
                              <?php echo e(request()->routeIs('cashier.transactions') ? 'active text-white' : ''); ?>">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" 
                           class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg
                                  <?php echo e(request()->routeIs('products.*') ? 'active text-white' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('categories.index')); ?>" 
                           class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg
                                  <?php echo e(request()->routeIs('categories.*') ? 'active text-white' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('products.create')); ?>" 
                           class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg
                                  <?php echo e(request()->routeIs('products.create') ? 'active text-white' : ''); ?>">
                    ...
                    <!-- Admin Section -->
                    <?php if(auth()->user()->email === 'admin@hmart.com' || auth()->user()->id === 1): ?>
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 px-3">
                        ...
                        <a href="<?php echo e(route('admin.users.index')); ?>" 
                           class="nav-link flex items-center space-x-3 p-3 text-gray-700 hover:text-blue-600 rounded-lg
                                  <?php echo e(request()->routeIs('admin.users.*') ? 'active text-white' : ''); ?>">
                        ...
                        <div class="space-y-2 px-3">
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-bold text-red-600">
                                    <?php echo e(\App\Models\Product::where('stock', '<', 10)->where('stock', '>', 0)->count()); ?>
                            ...
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-bold text-green-600">
                                    Rp <?php echo e(number_format(\App\Models\Transaction::whereDate('created_at', today())->sum('total_amount') ?? 0, 0, ',', '.')); ?>
        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                ...
                                H'Mart Supermarket • <?php echo e(now()->format('l, d F Y')); ?>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="bg-blue-50 px-4 py-2 rounded-lg">
                                ...
                                <div class="font-bold text-blue-600"><?php echo e(auth()->user()->name); ?></div>
                            </div>
            ...
            <!-- Content Area - HANYA INI YANG BISA SCROLL -->
                ...
                <div class="flex justify-between items-center text-sm text-gray-600">
                    ...
                    <div class="text-right">
                        <div class="text-xs text-gray-500">
                            <span id="clockTime"><?php echo e(date('H:i:s')); ?></span>
                        </div>
                    </div>
                </div>
            </footer>
...
</html><?php /**PATH D:\KULIAH\SERTIFIKASI\h-mart-kasir\resources\views/layouts/cashier.blade.php ENDPATH**/ ?>