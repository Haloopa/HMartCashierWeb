        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                    ...
                    H'Mart Supermarket • <?php echo e(now()->format('d F Y')); ?>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="bg-gray-100 px-4 py-2 rounded-lg">
                    ...
                    <div id="currentTime" class="font-mono font-bold"><?php echo e(date('H:i:s')); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-5">
            ...
            <div class="text-3xl font-bold text-gray-900">
                <?php echo e(\App\Models\Transaction::whereDate('created_at', today())->count()); ?>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                        ...
                        <div class="text-2xl font-bold text-green-600"><?php echo e($inStockCount); ?></div>
                    </div>
                    ...
                    <div class="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                        ...
                        <div class="text-2xl font-bold text-yellow-600"><?php echo e($lowStockCount); ?></div>
                    </div>
                    ...
                    <div class="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                        ...
                        <div class="text-2xl font-bold text-red-600"><?php echo e($outOfStockCount); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-gray-900"><?php echo e($transaction->user->name); ?></div>
                        </td>
                        <td class="px-6 py-4">
...
<?php echo $__env->make('layouts.cashier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\SERTIFIKASI\h-mart-kasir\resources\views/dashboard.blade.php ENDPATH**/ ?>